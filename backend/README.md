...
## Project Structure
    ...
    ├── billowing_waterfall_38889  # Django project configurations
...
1. Clone this repo and `cd billowing_waterfall_38889`
...
2. Clone this repo and `cd billowing_waterfall_38889`
